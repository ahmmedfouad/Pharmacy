...
const translations = {
  en: {
    ...
    ageHelper: "Only ages from 18 to 65 years are accepted.",
    ageAlertTitle: "Invalid age",
    ageAlertMessage: "Please enter one valid age between 18 and 65 years.",
  ...
  ar: {
    ...
    ageInputPlaceholder: "أدخل عمرك (18-65)",
    ageHelper: "يتم قبول الأعمار من 18 إلى 65 سنة فقط.",
    ageAlertTitle: "عمر غير صالح",
    ageAlertMessage: "يرجى إدخال عمر صحيح واحد بين 18 و65 سنة.",
